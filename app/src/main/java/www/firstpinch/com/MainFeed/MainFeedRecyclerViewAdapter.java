...
//adapter for mainFeedRecyclerView
public class MainFeedRecyclerViewAdapter extends RecyclerView.Adapter<MainFeedRecyclerViewAdapter.MyViewHolder> {
    ...
    public MainFeedRecyclerViewAdapter(Context context, final List<MainFeedObject> data) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (current.getPreview_link().contentEquals("null") ||current.getPreview_link().contentEquals(" ")|| current.getPreview_link().contentEquals("") || current.getPreview_link().isEmpty()) {
        ...
        if (current.getPost_ques() == 0) {
            ...
            holder.text_responses.setText("All Answers");
    ...
    //make the links clickable in description
    ...
    //onClick called when links are clicked
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(final View itemView) {
            ...
            //all the onCLicks on MainFeedItem below
            ...
            tv_title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        ((Home) c).startActivityForResult(intent,FEED_DELETE);
