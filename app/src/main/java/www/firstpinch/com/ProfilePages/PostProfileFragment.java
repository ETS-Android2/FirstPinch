...
//postProfileFragment of ProfileActivity.java
public class PostProfileFragment extends Fragment {

    public static String house = "", GET_POST_PROFILE_FEED_URL = "http://54.169.84.123/api/getUserStory", profile_id;
    int count = 0;
    private RecyclerView recyclerView;
    private PostProfileFragmentAdapter recyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.post_profile_fragment, container, false);
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipeRefreshLayout);
        tv_empty_recyclerview = (TextView) view.findViewById(R.id.tv_empty_recyclerview);
        //to refresh the feed on swipe down
        ...
        recyclerAdapter = new PostProfileFragmentAdapter(getActivity(), data);
        ...
        //on Scroll to request data from API
    ...
    //delete item when deleted from ProfileActivity.java
    ...
    //get post profile data from API request
                    ...
                    public void onResponse(String response) {
                        ...
                        if (data.isEmpty()) {
                            ...
                            if (profile_id.contentEquals(String.valueOf(user_id))) {
                                tv_empty_recyclerview.setText("Hey! We are waiting to read your first post");
                            } else {
                                tv_empty_recyclerview.setText("This Firstpincher hasn't pinched a Post yet !!");
                            }
                        } else {
