...
//adapter for questionProfileFragment recyclerview
public class QuestionProfileFragmentAdapter extends RecyclerView.Adapter<QuestionProfileFragmentAdapter.MyViewHolder> {
    ...
    public QuestionProfileFragmentAdapter(Context context, final List<MainFeedObject> data) {
    ...
    @Override
    public QuestionProfileFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflator.inflate(R.layout.post_profile_recyclerview_item, parent, false);
        QuestionProfileFragmentAdapter.MyViewHolder holder = new QuestionProfileFragmentAdapter.MyViewHolder(view);
    ...
    /*public void changeCommData(int position){
        global_holder.hint_comm_title.setText(data.get(position).getHint_comm_title());
        global_holder.hint_comm_profile_name.setText(data.get(position).getHint_comm_profile_name());
        Picasso.with(c)
                .load(data.get(position).getHint_comm_profile_image())
                .into(global_holder.hint_comm_profile_image);
    }*/

    @Override
    public void onBindViewHolder(final QuestionProfileFragmentAdapter.MyViewHolder holder, final int position) {
    ...
    @Override
    public void onBindViewHolder(final QuestionProfileFragmentAdapter.MyViewHolder holder, final int position, List<Object> payloads) {
    ...
    //add question as bookmarks API request
    ...
    //add post as bookmarks API request
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_houseName, tv_title, tv_desc, tv_post_ques,
                tv_rating, tv_totalComments, tv_totalShares, tv_appreciations_count, tv_score, tv_responses, preview_title, preview_description, text_score;
        ...
        public MyViewHolder(final View itemView) {
            ...
            tv_see_all_comments.setTypeface(custom_font1);

            TextView appreciationtextstyleprofile = (TextView) itemView.findViewById(R.id.text_appreciations);
            appreciationtextstyleprofile.setTypeface(custom_font1);

            TextView textscorestyle = (TextView) itemView.findViewById(R.id.text_score);
            textscorestyle.setTypeface(custom_font1);
            ...
            TextView coretexststyleprofile = (TextView) itemView.findViewById(R.id.tv_score);
            coretexststyleprofile.setTypeface(custom_font1);
            ...
            tv_title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((ProfileActivity) c).startActivityForResult(intent, QUESTION_FEED_DELETE);
                }
            });
