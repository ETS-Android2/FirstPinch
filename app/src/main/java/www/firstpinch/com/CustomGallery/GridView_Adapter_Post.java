...
//adapter for pinching a post from home and profile
public class GridView_Adapter_Post extends BaseAdapter {
    ...
    public GridView_Adapter_Post(Context context, ArrayList<ImageObject> imageUrls, boolean isCustomGalleryActivity, int check_integer) {
                            ...
                            try {
                                ...
                                if (status.contentEquals("true")) {
                                    try {
                                        ...
                                        selectedImagesss = ((PinchAPost) context).getSelectedImages();
                                        selectedImagesss.remove(position);
                                        ((PinchAPost) context).setSelectedImages(selectedImagesss);
                                        image_count = ((PinchAPost) context).getImages_count();
                                        image_count--;
                                        if (selectedImagesss.size() == image_count) {
                                            ((PinchAPost) context).setVisibilityVisible();
                                        } else {
                                            ((PinchAPost) context).setVisibilityGone();
                                        }
                                        ((PinchAPost) context).setImages_count(image_count);
                                        notifyDataSetChanged();
                                    } catch (Exception e) {
                                        Log.e("GridViewAdapterPost", "" + e.toString());
