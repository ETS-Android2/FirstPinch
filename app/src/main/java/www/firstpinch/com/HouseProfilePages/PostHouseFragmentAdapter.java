...
//adapter for post house frament
public class PostHouseFragmentAdapter extends RecyclerView.Adapter<PostHouseFragmentAdapter.MyViewHolder> {
    ...
    public PostHouseFragmentAdapter(Context context, final List<MainFeedObject> data) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (current.getPreview_link().contentEquals("null") || current.getPreview_link().contentEquals("") || current.getPreview_link() == null) {
            ...
            //preview image present or not check
    ...
    //add question bookmark API request
    ...
    //delete question bookmark API request
    ...
    //delete post bookmark API request
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView hint_comm_profile_name, hint_comm_title, hint_comm_profile_name2, hint_comm_title2, tv_see_all_comments, tv_comment;
        ...
        public MyViewHolder(final View itemView) {
            ...
            TextView textResponsesStyle = (TextView) itemView.findViewById(R.id.text_responses);
            ...
            textResponsesStyle.setTypeface(custom_font1);
            ...
            //all onCLicks on item view of posts in house
            ...
            tv_title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((HouseProfileActivity) c).startActivityForResult(intent,POST_FEED_DELETE);
                }
            });
