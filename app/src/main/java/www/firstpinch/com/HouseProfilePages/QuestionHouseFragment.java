...
//question fragment in house page
public class QuestionHouseFragment extends Fragment {

    public static String house = "", GET_QUESTION_HOUSE_FEED_URL = "http://54.169.84.123/api/getClubQuestions",
            house_id,house_name="";
    private RecyclerView recyclerView;
    private QuestionHouseFragmentAdapter recyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.question_house_fragment, container, false);
...
//Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
    ...
    //called when feed item is deleted from house page
    ...
    //get questions for house page API request
    private void get_feed(final int page_index) {

        loading = true;
        RequestQueue requestQueue = Volley.newRequestQueue(getActivity());

        StringRequest stringRequest = new StringRequest(Request.Method.GET, GET_QUESTION_HOUSE_FEED_URL,
                ...
                //to read any type of error in response from server
