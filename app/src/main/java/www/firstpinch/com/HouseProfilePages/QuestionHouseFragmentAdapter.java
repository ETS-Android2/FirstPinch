...
//adapter for questions in house page
public class QuestionHouseFragmentAdapter extends RecyclerView.Adapter<QuestionHouseFragmentAdapter.MyViewHolder> {
    ...
    int pos = 0, user_id,QUESTION_FEED_DELETE=2;

    public QuestionHouseFragmentAdapter(Context context, final List<MainFeedObject> data) {
    ...
    @Override
    public QuestionHouseFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflator.inflate(R.layout.post_house_recycleview_item, parent, false);
        QuestionHouseFragmentAdapter.MyViewHolder holder = new QuestionHouseFragmentAdapter.MyViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final QuestionHouseFragmentAdapter.MyViewHolder holder, final int position) {
        ...
        //read the links in description and make them clickable
    ...
    @Override
    public void onBindViewHolder(final QuestionHouseFragmentAdapter.MyViewHolder holder, final int position, List<Object> payloads) {
    ...
    //onClick called when links in desc clicked
    ...
    //add question as bookmark API request
    ...
    //remove question as bookmark API request
    ...
    //add post as bookmark API request
    ...
    //remove post as bookmark API request
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView im_profileImageUrl, preview_image;
        CardView preview_cardview;
        FrameLayout fl_images;
        TextView tv_profileName, tv_profileUsername, tv_title, tv_desc, tv_post_ques,
        ...
        ImageView hint_comm_profile_image, hint_comm_profile_image2,
                add_comment_profile_image, share, im_menu_button;
...
//tv_rating = (TextView) itemView.findViewById(R.id.feed_rate);
            ...
            TextView appreciationtextstylehouse = (TextView) itemView.findViewById(R.id.text_appreciations);
            appreciationtextstylehouse.setTypeface(custom_font1);

            TextView textscorestylehouse = (TextView) itemView.findViewById(R.id.text_score);
            textscorestylehouse.setTypeface(custom_font1);


            TextView responsestextstylehouse = (TextView) itemView.findViewById(R.id.text_responses);
            responsestextstylehouse.setTypeface(custom_font1);
            ...
            TextView coretexststylehouse = (TextView) itemView.findViewById(R.id.tv_score);
            coretexststylehouse.setTypeface(custom_font1);

            //all onClicks on item view below
            ...
            tv_title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((HouseProfileActivity) c).startActivityForResult(intent,QUESTION_FEED_DELETE);
                }
            });
