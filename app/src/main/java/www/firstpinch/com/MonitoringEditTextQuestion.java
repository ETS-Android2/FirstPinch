...
public class MonitoringEditTextQuestion extends EditText {
     ...
     */
    public MonitoringEditTextQuestion(Context context) {
        super(context);
    ...
    public MonitoringEditTextQuestion(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    public MonitoringEditTextQuestion(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onTextPaste() {
        try {
            ...
            if (m.find()) {
                ...
                ((PinchAQues) context).setPreviewQuestion(cd_item.getText().toString());
            }
        } catch (Exception e) {
            Log.e("MonitoringEditText", "Question" + e.toString());
