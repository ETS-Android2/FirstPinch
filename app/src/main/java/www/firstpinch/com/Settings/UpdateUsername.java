...
public class UpdateUsername extends AppCompatActivity {
    ...
    String UPDATE_PASSWORD = "http://54.169.84.123/api/userUpdate", USERNAME_CHECK_URL = "http://54.169.84.123/api/checkuname",
            username, GET_PROFILE_DETAILS_URL = "http://54.169.84.123/api/users/profile/1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_pass.setTypeface(custom_font1);
        bt_update_username.setTypeface(custom_font1);
    ...
    private void updateUsername() {
        ...
        final String str_password = et_pass.getText().toString().trim();
        ...
        StringRequest myReq = new StringRequest(Request.Method.PUT,
            ...
            public byte[] getBody() {
                ...
                questionHash.put("current_password", str_password);
            ...
            public void onResponse(String response) {
                ...
                if (response != null) {
                    try {
                        ...
                        error_global.initializeVar(UpdateUsername.this, e.toString());
