...
import www.firstpinch.com.firstpinch2.CustomGallery.GridView_Adapter_QuestionInHouse;
...
/**
 * Created by Rianaa Admin on 16-11-2016.
 */

public class PinchAQuesInHouse extends AppCompatActivity implements View.OnClickListener {

    EditText et_question, et_house_id;
    MonitoringEditTextQuestionInHouse et_content;
    ...
    ImageView image_close,preview_close, preview_image;
    ...
    String unidata, unislug, user_image;
    int unil;
    //for slug
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pinchaquestion_inhouse);
        ...
        et_content = (MonitoringEditTextQuestionInHouse) findViewById(R.id.et_ques_desc);
        ...
        View grayline6 = (View) findViewById(R.id.grayline6);
        ...
        if (sp1.getBoolean("draft", false)) {
            ...
            if (data.size() > 0) {
                try {
                    ...
                    Log.e("Exception","Pinch ques in house"+e.toString());
                    Error_GlobalVariables error_global = new Error_GlobalVariables();
                    error_global.initializeVar(PinchAQuesInHouse.this, e.toString());
                }
            }
        }
    ...
    public void setPreviewQuestionInHouse(final String url) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, GET_HOUSES_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ArrayAdapter ar_obj1 = new ArrayAdapter<String>(PinchAQuesInHouse.this, android.R.layout.select_dialog_item, strings);
    ...
    private void loadGridView(ArrayList<String> imagesArray) {
        GridView_Adapter_QuestionInHouse adapter = new GridView_Adapter_QuestionInHouse(this, imagesArray, false);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
                        ...
                        builder.setNegativeButton("Save", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                content = et_content.getText().toString();
                                question = et_question.getText().toString();
                                db.addQuestionData(question, content, "", "", "1");
                                SharedPreferences prefs = getSharedPreferences("draft_question", Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = prefs.edit();
