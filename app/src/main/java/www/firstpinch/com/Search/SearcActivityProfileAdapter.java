 ...
 */
public class SearcActivityProfileAdapter extends RecyclerView.Adapter<SearcActivityProfileAdapter.MyViewHolder> {

    private LayoutInflater inflator;
    List<SearchActivityObject> data = Collections.emptyList();
    Context c;

    public SearcActivityProfileAdapter(Context context, List<SearchActivityObject> data){
    ...
    @Override
    public SearcActivityProfileAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflator.inflate(R.layout.search_activty_item, parent, false);
        SearcActivityProfileAdapter.MyViewHolder holder = new SearcActivityProfileAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final SearcActivityProfileAdapter.MyViewHolder holder, int position) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(final View itemView) {
            ...
            //onCLicks on profile items in searched profile fragment
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("profilename", current.getSearch_name());
                    intent.putExtra("imageurl", current.getSearch_image());
                    intent.putExtra("profile_id", "" + current.getId());
