...
/**
 * Created by Rianaa Admin on 06-12-2016.
 */

public class SearchPostFragmentAdapter extends RecyclerView.Adapter<SearchPostFragmentAdapter.MyViewHolder> {
    ...
    public SearchPostFragmentAdapter(Context context, List<SearchQuestionsFragmentObject> data) {
    ...
    @Override
    public SearchPostFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflator.inflate(R.layout.search_ques_recyclerview_item, parent, false);
        SearchPostFragmentAdapter.MyViewHolder holder = new SearchPostFragmentAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final SearchPostFragmentAdapter.MyViewHolder holder, int position) {
