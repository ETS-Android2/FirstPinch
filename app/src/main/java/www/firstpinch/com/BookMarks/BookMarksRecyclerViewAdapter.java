...
public class BookMarksRecyclerViewAdapter extends RecyclerView.Adapter<BookMarksRecyclerViewAdapter.MyViewHolder> {
    ...
    String GET_TAG_USERS_URL = "http://54.169.84.123/api/getTagUserQuestion",
    ...
    int pos = 0;
    MyViewHolder global_holder;
    List<String> mStrings = new ArrayList<String>();
    int question_id, user_id,FEED_DELETE=1;
    ProgressDialog progressDialog;
    // Array of strings storing country names

    public BookMarksRecyclerViewAdapter(Context context, final List<MainFeedObject> data) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.tv_profileName.setText(current.getProfileName());
        holder.tv_profileUsername.setText(current.getProfileUsername());
        //Log.e("images_count=", "" + current.arr_images.size());

        if (current.getPreview_link().contentEquals("null") || current.getPreview_link().contentEquals("") || current.getPreview_link().isEmpty()) {
        ...
        /*try {
            current.setDesc(URLDecoder.decode(current.getDesc(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }*/
        holder.tv_desc.setText(current.getDesc().trim());
        ...
        holder.hint_comm_profile_name.setText(current.getHint_comm_profile_name());
        Picasso.with(c)
                .load(current.getHint_comm_profile_image())
                .placeholder(R.drawable.placeholder_image)
                .transform(new RoundedCornersTransform())
        ...
        if (current.getPost_ques() == 0) {
            holder.tv_post_ques.setText("post");
            holder.tv_comment.setText("Respond Now");
            holder.text_responses.setText("Responses");
            ...
            holder.tv_post_ques.setText("question");
            holder.tv_comment.setText("Answer Now");
            holder.text_responses.setText("Answers");
            holder.tv_title.setTextColor(0xff06aba5);
            //holder.tv_score.setVisibility(View.GONE);
            //holder.text_score.setVisibility(View.GONE);
        }
        ...
        Picasso.with(c)
                ...
                .placeholder(R.drawable.placeholder_image)
                .transform(new RoundedCornersTransform())
                .into(holder.im_profileImageUrl);
        /*Picasso.with(c)
                .load(current.getProfileImageUrl())
                .transform(new RoundedCornersTransform())
        ...
        if (current.getNum_of_images() == 0) {
            ...
            Picasso.with(c)
                    ...
                    .placeholder(R.drawable.placeholder_image)
                    .into(holder.i3_3);
        } else if (current.getNum_of_images() == 4 || current.getNum_of_images() == 5 || current.getNum_of_images() == 6) {
            holder.ll_container.setVisibility(View.VISIBLE);
            holder.l1.setVisibility(View.GONE);
            holder.l2.setVisibility(View.GONE);
            holder.l3.setVisibility(View.GONE);
    ...
    //for tags and links in the feed
    ...
    //use the data from other class
    public List<MainFeedObject> getList() {
        return data;
    }

    //read the links and call webview on click
    ...
    //for animating items in recycler view(currently not used)
    ...
    //add question in bookmarks API request
    ...
    //delete question from bookmarks API request
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView im_houseImageUrl, im_profileImageUrl, preview_image, im_hint_comm_delete;
        CardView preview_cardview;
        FrameLayout fl_images;
        TextView tv_houseName, tv_profileName, tv_profileUsername, tv_title, tv_desc, tv_post_ques,
                tv_rating, tv_totalComments, tv_totalShares, tv_appreciations_count, tv_score, tv_responses,
                text_score, text_responses, preview_title, preview_description;
        Button r1, r2, r3, r4, r5, comment, bt_hint_comm_appreciate;
        ...
        EditText ac_tv_add_comm;
        ImageView hint_comm_profile_image, hint_comm_profile_image2, add_comment_profile_image
                , share, im_menu_button;
        TextView hint_comm_profile_name, hint_comm_title, hint_comm_profile_name2, hint_comm_title2, tv_see_all_comments, tv_comment, pinchTextStyle;
        ...
        public MyViewHolder(final View itemView) {
            ...
            TextView appreciationTextStyle = (TextView) itemView.findViewById(R.id.text_appreciations);

            TextView responsesTextStyle = (TextView) itemView.findViewById(R.id.text_responses);
            TextView commentTextStyle = (TextView) itemView.findViewById(R.id.main_feed_comment_text);

            appreciationTextStyle.setTypeface(custom_font1);

            responsesTextStyle.setTypeface(custom_font1);
            commentTextStyle.setTypeface(custom_font1);

            tv_houseName = (TextView) itemView.findViewById(R.id.feed_house_name);
            tv_profileName = (TextView) itemView.findViewById(R.id.feed_profile_name);
            tv_profileUsername = (TextView) itemView.findViewById(R.id.feed_profile_username);
            ...
            pinchTextStyle = (TextView) itemView.findViewById(R.id.pinch_text);
            ...
            tv_houseName.setTypeface(custom_font1);
            tv_profileName.setTypeface(custom_font1);
            tv_profileUsername.setTypeface(custom_font1);
            tv_post_ques.setTypeface(custom_font1);
            ...
            im_profileImageUrl = (ImageView) itemView.findViewById(R.id.feed_profile_pic);
            ...
            //im_hint_comm_delete = (ImageView) itemView.findViewById(R.id.im_hint_comm_delete);
            ...
            //bt_hint_comm_appreciate = (Button) itemView.findViewById(R.id.bt_appreciate);
            ...
            //ac_tv_add_comm = (EditText) itemView.findViewById(R.id.feed_add_comment_et);
            ...
            //on clicks on all items of the feed
            ...
            tv_profileName.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        intent.putExtra("username", current.getProfileUsername());
                        intent.putExtra("imageurl", current.getProfileImageUrl());
                        intent.putExtra("profile_id", "" + current.getMainfeed_user_id());
            ...
            im_profileImageUrl.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    try {
                        MainFeedObject current = data.get(getAdapterPosition());
            ...
            rl_house_head.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    try {
                        MainFeedObject current = data.get(getAdapterPosition());
                        ...
                        intent.putExtra("housedesc", current.getHouseDesc());
            ...
            tv_desc.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    //Log.e("getSelectiononENd",""+tv_desc.getText());
                    if (tv_desc.getSelectionStart() == -1 && tv_desc.getSelectionEnd() == -1) {
                        try {
            ...
            /*comment.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (ac_tv_add_comm.getText().toString().contentEquals("")) {
                        Toast.makeText(c, "Blank comment not allowed",
                                Toast.LENGTH_LONG).show();
                    } else {
                        if (ac_tv_add_comm != null) {
                            InputMethodManager imm = (InputMethodManager) c.getSystemService(Context.INPUT_METHOD_SERVICE);
                            imm.hideSoftInputFromWindow(ac_tv_add_comm.getWindowToken(), 0);
                            rl_comment_hint.setVisibility(View.VISIBLE);
                            hint_comm_title.setText(ac_tv_add_comm.getText().toString());
                            hint_comm_profile_name.setText("Vishal Puri");
                            Picasso.with(c)
                                    .load("https://s3.amazonaws.com/cdn.firstpinch.com/spree/user_profile_pic/26/original/fbdp.jpg?1473159927")
                                    .transform(new RoundedCornersTransform())
                                    .into(hint_comm_profile_image);
                        }
