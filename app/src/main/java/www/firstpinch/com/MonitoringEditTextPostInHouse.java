...
public class MonitoringEditTextPostInHouse extends EditText {
     ...
     */
    public MonitoringEditTextPostInHouse(Context context) {
        super(context);
    ...
    public MonitoringEditTextPostInHouse(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    public MonitoringEditTextPostInHouse(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onTextPaste() {
        try {
            ...
            if (m.find()) {
                ...
                ((PinchAPostInHouse) context).setPreviewPostInHouse(cd_item.getText().toString());
            }
        } catch (Exception e) {
            Log.e("MonitoringEditText", "PostInHouse" + e.toString());
