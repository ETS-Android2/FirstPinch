...
/**
 * Created by Rianaa Admin on 21-09-2016.
 */

public class Scroll_House_fab extends FloatingActionButton.Behavior {

    Context c;
    private Animation rotate_backward;
    Home hm= new Home();

    public Scroll_House_fab(Context context, AttributeSet attributeSet) {
        super();
        this.c = context;
