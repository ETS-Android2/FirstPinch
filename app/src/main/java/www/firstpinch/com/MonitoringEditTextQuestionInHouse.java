...
/**
 * Created by Rianaa Admin on 30-11-2016.
 */

public class MonitoringEditTextQuestionInHouse extends EditText {
     ...
     */
    public MonitoringEditTextQuestionInHouse(Context context) {
        super(context);
    ...
    public MonitoringEditTextQuestionInHouse(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        clipboard = (ClipboardManager) context.getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    public MonitoringEditTextQuestionInHouse(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onTextPaste() {
        try {
            ...
            if (m.find()) {
                ...
                ((PinchAQuesInHouse) context).setPreviewQuestionInHouse(cd_item.getText().toString());
            }
        } catch (Exception e) {
            Log.e("MonitoringEditText", "QuestionInHouse" + e.toString());
